...
如果项目已在生产服务器上运行，更新代码时需要注意以下事项：

- **备份数据**：更新前务必备份数据库和配置文件
- **停止服务**：避免在定时任务运行时更新代码
- **测试验证**：更新后测试数据源连通性和核心功能
- **监控日志**：关注更新后的运行日志，及时发现问题

详细指南请参考：[生产环境代码更新指南](docs/生产环境代码更新指南.md)
...
- [生产环境代码更新指南](docs/生产环境代码更新指南.md) - 更新代码注意事项
- [服务器部署指南](docs/服务器部署指南.md) - 首次部署完整指南
- [部署调整清单](docs/部署调整清单.md) - 配置调整检查清单
